    ...
    <div class="container">
        <div class="card mt-4">
            <div class="card-header bg-warning">
                <div class="card-title">
                    <h3 class="text-center text-dark">
                        Payment for Hotel Booking at {{$hotel->destination}}
                    </h3>
                </div>
            </div>
            <div class="card-body" style="background: #EBF8A4;">
                ...
                <form action="{{route('hotel.booking.store', $hotel->id)}}" method="POST">
                    @csrf 
                    ...
                    <div class="form-group mb-4">
                        <input type="hidden" step="any" name="amount" class="form-control" placeholder="Enter Amount" value="{{$hotel->amount}}">
                        
                        <input type="number" step="any" name="amountView" class="form-control" placeholder="Enter Amount" value="{{$hotel->amount}}" disabled>
                    </div>
                    <div class="form-group mb-4">
