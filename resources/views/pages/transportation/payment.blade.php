    ...
    <div class="container">
        <div class="card mt-4">
            <div class="card-header bg-warning">
                <div class="card-title">
                    <h3 class="text-center text-dark">
                        Payment for Transportation Service from {{$transport->location}}
                    </h3>
                </div>
            </div>
            <div class="card-body" style="background: #EBF8A4;">
                ...
                <form action="{{route('transportation.payment.store', $transport->id)}}" method="POST">
                    @csrf 
                    ...
                    <div class="form-group mb-4">
                        <input type="hidden" step="any" name="amount" class="form-control" placeholder="Enter Amount" value="{{$transport->amount}}">
                        
                        <input type="number" step="any" name="amountView" class="form-control" placeholder="Enter Amount" value="{{$transport->amount}}" disabled>
                    </div>
                    <div class="form-group mb-4">
